        ...
        <div>
           ...
           <div className='w-full  flex gap-8 mt-20'>
                <div className='w-1/2    flex flex-col gap-16'>
                    <div>
                    <h1 className='text-5xl text-primary font-bold'>Olá, eu sou</h1>
                    <h1 className='text-5xl'>Desenvolvedor Frontend</h1>
                    </div>
                    <div className='flex w-full  gap-8'>
                        <div className="flex w-1/2 border border-black cursor-pointer rounded-md justify-center flex-col items-center p-5 gap-10 text-center">
                ...
                <div className='w-1/2  px-4 flex justify-between flex-col items-center'>
                    <VideoPlayer/> 
                    <div className='w-full  gap-4 flex justify-between items-center flex-col'>
